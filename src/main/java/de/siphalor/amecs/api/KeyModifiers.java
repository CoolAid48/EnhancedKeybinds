...
public class KeyModifiers {
    ...
    public static KeyModifiers getCurrentlyPressed() {
        return Amecs.CURRENT_MODIFIERS;
    }
     ...
     * @param control   sets whether the control flag should be set
     * @param shift     sets whether the shift flag should be set
     * @param super_    sets whether the super flag should be set
     */
    public KeyModifiers(boolean alt, boolean control, boolean shift, boolean super_) {
        this();
        setAlt(alt);
        setControl(control);
        setShift(shift);
     ...
     * Use {@link Amecs#CURRENT_MODIFIERS} in combination with {@link #contains(KeyModifiers)} or {@link #equals(KeyModifiers)} instead.
     */
    @Deprecated
    ...
    /**
     * Gets the state of the super flag
     */
    public boolean getSuper() {
        return get(KeyModifier.SUPER);
    }

    /**
     * Sets the state of the super flag
     */
    public KeyModifiers setSuper(boolean value) {
        set(KeyModifier.SUPER, value);
        return this;
    }
